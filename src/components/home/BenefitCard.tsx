...
export const BenefitCard = ({ icon: Icon, title, description, color, index }: BenefitCardProps) => (
  ...
  >
    <div className="h-full bg-card border border-border/50 rounded-none p-6 transition-colors duration-300 hover:border-primary/30 hover:  hover:shadow-primary/5 hover:-translate-y-1 group">
      <div className={`w-12 h-12 rounded-none flex items-center justify-center mb-4 transition-colors duration-300 ${
