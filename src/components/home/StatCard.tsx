...
export const StatCard = ({ icon: Icon, value, label, variants }: StatCardProps) => {
  ...
  return (
    <motion.div variants={variants} ref={ref}>
      <Card className="bg-gradient-to-br from-card to-card/50 border-border/50 hover:border-primary/30 transition-colors duration-300 hover:  hover:shadow-primary/10">
